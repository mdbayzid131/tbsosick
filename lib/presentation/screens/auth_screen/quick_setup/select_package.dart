...
/// ============================================================================
/// SELECT PACKAGE SCREEN (Quick Setup Fallback)
/// ============================================================================
/// Note: AppRoutes.selectPackage is configured in app_pages.dart to route to
/// SubscriptionScreen() to ensure a single unified, clean subscription UI.
/// ============================================================================
          ...
          children: [
            Column(
              children: [
                ...
                // Bottom Action Button with onboarding logic and compliance links
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          onPressed: () async {
                            if (controller.isSelectedPlanCurrent || controller.selectedPlan.value == 0) {
                              ...
                              if (controller.selectedPlan.value == 0) {
                                await controller.subscribe(); // Calls chooseFreePlan on the backend
                              }
                      ...
                      Row(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () => controller.launchLegalUrl('https://smrtscrub.app/terms'),
                            child: Text(
                              'Terms of Service',
                              style: GoogleFonts.arimo(
                                fontSize: 11.sp,
                          ...
                          GestureDetector(
                            onTap: () => controller.launchLegalUrl('https://smrtscrub.app/privacy'),
                            child: Text(
                              'Privacy Policy',
                              style: GoogleFonts.arimo(
                                fontSize: 11.sp,
        ...
        GestureDetector(
          ...
          child: Obx(
            () => _planCard(
              ...
              currentPlan: controller.isPlanCurrent(0, isYearly: isYearly),
            ),
          ),
        ),
              ...
              return Padding(
                ...
                child: GestureDetector(
                  ...
                  child: _planCard(
                    ...
                    currentPlan: controller.isPlanCurrent(planIndex, isYearly: isYearly),
                  ),
                ),
              );
            }).toList(),
