...
import 'package:tbsosick/presentation/screens/home/New%20Private%20Card/priver_medical_supplies_container.dart';
import 'package:tbsosick/presentation/screens/home/New%20Private%20Card/privet_sutures_container.dart';
...
import '../Preference card/medical_supplies_container.dart';

class NewPrivateCard extends StatefulWidget {
  const NewPrivateCard({super.key});

  @override
  State<NewPrivateCard> createState() => _NewPrivateCardState();
}

class _NewPrivateCardState extends State<NewPrivateCard> {
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                PriverMedicalSuppliesContainer(),

                SizedBox(height: 20.h),
                PrivetSuturesContainer(),
                SizedBox(height: 20.h),
                CustomContainer(
                  child: Column(
                    children: [
