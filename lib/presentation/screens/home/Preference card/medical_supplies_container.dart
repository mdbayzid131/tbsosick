...
class MedicalSuppliesContainer extends StatefulWidget {
  const MedicalSuppliesContainer({super.key});

  @override
  State<MedicalSuppliesContainer> createState() =>
      _MedicalSuppliesContainerState();
}

class _MedicalSuppliesContainerState extends State<MedicalSuppliesContainer> {
  // Selected supplies
