              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: _tabController.index == 0
                      ...
                      : null,
                  color: _tabController.index != 0 ? Color(0xffCFC8DF) : null,
                  boxShadow: [
                    BoxShadow(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: _tabController.index == 1
                      ...
                      : null,
                  color: _tabController.index != 1 ? Color(0xffCFC8DF) : null,
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black.withOpacity(0.08),
                      blurRadius: 12,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 12.h),
          // Tags row - specialty, verified, duration
          Row(
            children: [
              // Specialty tag
              Container(
          ...
          // Bottom row - downloads, updated time, download button
          Row(
            children: [
              // Downloads count
              Icon(
